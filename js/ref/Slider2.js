function _getClosest(item, array, getDiff) {
  ...
  if (!Array.isArray(array)) {
    throw new TypeError('Get closest expects an array as second argument')
  }
...
export class Slider {
  ...
  bind() {
    const methods = ['setPos', 'run', 'on', 'off', 'resize']
  ...
  setPos(e) {
    ...
    this.currentX = this.offX + (e.offsetX - this.onX) * this.opts.speed
    this.clamp()
  }
